        ...
        <div className='h-screen overflow-y-auto bg-slate-700'>
            ...
            <div className="flex justify-center mt-10">
                <form onSubmit={(e) => { e.preventDefault(); SearchRecipe(foodItem); }}>
                    <input value={foodItem} onChange={(e) => setFoodItem(e.target.value)} placeholder='Search Recipe' type="text" className="p-4 w-80 text-black bg-slate-200 shadow-2xl rounded-3xl" />
                </form>
            </div>
